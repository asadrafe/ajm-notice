...
export default function App() {
  ...
  const di = { width:"100%", padding:"7px 10px", border:"1px solid #444",
  ...
  const hr  = { borderTop:"1px solid #2e2e2e", margin:"16px 0" };
  const card = { background:"#222", borderRadius:"6px", padding:"12px 14px", marginBottom:"16px" };
  ...
  return (
    <div style={{ display:"flex", minHeight:"100vh", fontFamily:"'Georgia', serif", background:"#f0ede8" }}>
      ...
      {/* ── Sidebar ── */}
      <div style={{ width:"340px", minWidth:"340px", background:"#1a1a1a", color:"#eee",
        padding:"22px 18px", overflowY:"auto", boxSizing:"border-box" }}>

        <div style={{ textAlign:"center", borderBottom:"1px solid #2e2e2e", paddingBottom:"14px", marginBottom:"18px" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"6px" }}>
            {NOTICE_TYPES.map(t => (
              <button key={t.value} onClick={() => applyTemplate(t.value)} style={{
                padding:"6px 8px", fontSize:"11px", cursor:"pointer", fontFamily:"inherit",
                textAlign:"left", lineHeight:"1.3", borderRadius:"3px",
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"10px", ...sec }}>
          <div>
        ...
        {currentIssuer?.canUploadSig && (
          <div style={card}>
            ...
            <ImageUploadBtn
              ...
              previewHeight={46}
            />
            <div style={{ fontSize:"10px", color:"#555", marginTop:"7px" }}>
        ...
        <div style={sec}>
          ...
          <textarea style={{ ...di, minHeight:"180px", resize:"vertical", lineHeight:"1.65" }}
        ...
        <div style={card}>
          ...
          {!logoImg && (
            <div style={{ display:"flex", alignItems:"center", gap:"8px", marginTop:"10px" }}>
              ...
              <label htmlFor="sealChk" style={{ fontSize:"11px", color:"#888", cursor:"pointer" }}>
        ...
        <div style={{ marginTop:"12px", fontSize:"10px", color:"#444", lineHeight:"1.6" }}>
